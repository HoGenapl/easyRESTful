<?php
namespace extend\RESTful;

class restful
{
    private $httpVersion = "HTTP/1.1";
    private $default_statuCode = 400;
    private $contentType;
    private $msg;
    public function send_init($statusCode)
    {
    ...
    public function getHttpStatusMessage($statusCode){
        ...
        return ($httpStatus[$statusCode]) ? $httpStatus[$statusCode] : $httpStatus[$this->default_statuCode];
    }
}